        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <p className="mt-6 max-w-3xl mx-auto text-xl text-foreground/80 leading-relaxed">
              Ласкаво просимо на наш сайт, де ТОВ "Агро-Солар" пропонує вам високоякісні шини CEAT для сільськогосподарських машин. Наше підприємство було засновано з метою надати ринку України високоякісні, надійні та доступні шини.
            </p>
          </div>
        </div>
      </section>
