  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-lg">
          тел.: <a href="tel:+380504249510" className="text-[#008e4ed3] hover:underline font-semibold">+38 050 424 95 10</a> Сергій
        </p>
        <p className="text-lg">
          тел.: <a href="tel:+380686007030" className="text-[#008e4ed3] hover:underline font-semibold">+38 068 600 70 30</a>
        </p>
        <p className="text-lg">
          Для замовлення пишіть на пошту
          <br />
          <a href="mailto:s.kostrov@agrosolar.com.ua" className="text-[#008e4ed3] hover:underline font-semibold">s.kostrov@agrosolar.com.ua</a>
        </p>
      </div>
